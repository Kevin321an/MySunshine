...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    public void onPerformSync(Account account, Bundle extras, String authority, ContentProviderClient provider, SyncResult syncResult) {
        ...
        try {
            ...
            //final String FORECAST_BASE_URL =  "http://api.openweathermap.org/data/2.5/forecast/city?id=6167865&APPID=f2cab325db52e7429c3cee3965c9c0b3";
    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        //to detect if jsonobject get the correct data
        ...
        try {
            ...
            // delete old data older than one day
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        Cursor locationCursor = getContext().getContentResolver().query(
                WeatherContract.LocationEntry.CONTENT_URI,//content://com.example.android.sunshine.app/location
                new String[]{WeatherContract.LocationEntry._ID},//_id  a const from primitive code
        ...
        if (displayNotifications) {
            ...
            if (System.currentTimeMillis() - lastSync >= DAY_IN_MILLIS) {
                ...
                if (cursor.moveToFirst()) {
                    ...
                    //read the ico id and url to prepare to load them
                    ...
                    @SuppressLint("InlinedApi")//Indicates that Lint should ignore the specified warnings for the annotated element.
    ...
    @Retention(RetentionPolicy.SOURCE) // these instants wont affect on the runtime
