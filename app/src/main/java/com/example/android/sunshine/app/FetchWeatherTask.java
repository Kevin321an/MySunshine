...
//must import the Data folder here
/**
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        * */
        ...
        /*Cursor locationCursor = mContext.getContentResolver().query(
                ...
                new String[]{WeatherContract.LocationEntry._ID}, // The columns to return for each row
                WeatherContract.LocationEntry.COLUMN_LOCATION_SETTING + " = ?", // Selection criteria
                new String[]{locationSetting},  // Selection criteria
        ...
        if (locationCursor.moveToFirst()) { //There are some content return by query as it can be movedToFirst
    ...
    */
    ...
    protected Void doInBackground(String... params) {
        ...
        try {
            ...
            //System.out.println("builtUri"+ url);
            ...
            getWeatherDataFromJson(forecastJsonStr, locationQuery); //requery the database after the insert.
        } catch (IOException e) {
