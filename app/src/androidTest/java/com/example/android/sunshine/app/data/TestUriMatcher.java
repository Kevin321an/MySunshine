...
//TEST_WEATHER_DIR=BASE_CONTENT_URI.buildUpon().appendPath(PATH_WEATHER).build();== content://" + CONTENT_AUTHORITY/weather==WeatherProvider.WEATHER==100
            assertEquals("Error: The WEATHER URI was matched incorrectly.",
                testMatcher.match(TEST_WEATHER_DIR), WeatherProvider.WEATHER);

        //content://" + CONTENT_AUTHORITY/weather/London,UK==WeatherProvider.WEATHER_WITH_LOCATION = 101;
